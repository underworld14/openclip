...
- Commits (2):
  - `936f8543` — fix(projects): reclaim per-project temp cache on delete, regenerate stale poster frames on reopen
...
```
 ...
 144 files changed, 10226 insertions(+), 439 deletions(-)
```
