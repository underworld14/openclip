...
- Commits (2):
  - `dc6c6ae1` — fix(quit,clips): confirm before quitting mid-job; reject/re-export selection stays consistent (BUG-adfj3b, BUG-gasxqq)
...
```
 ...
 70 files changed, 3246 insertions(+), 77 deletions(-)
```
