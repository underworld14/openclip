---
id: EPIC-c2gg45
title: 'EPIC: Pipeline performance — ffmpeg decode, reframe, and renderer hot paths'
status: done
priority: high
labels:
    - perf
created: "2026-08-08T15:31:22Z"
updated: "2026-08-14T13:45:19Z"
---
...
```
 ...
 vitest.config.ts                                   |  12 +-
 249 files changed, 29217 insertions(+), 1103 deletions(-)
```
