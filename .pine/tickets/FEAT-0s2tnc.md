...
- Commits (2):
  - `992fb538` — feat(captions): the template gallery is live thumbnails, beside the preview (FEAT-0s2tnc)
...
```
 ...
 src/main/services/ai-client.ts                     | 360 ++++++++--
 ...
 src/main/services/jobs/export-runner.ts            | 144 +++-
 ...
 src/renderer/src/components/ExportPanel.tsx        | 224 ++++---
 .../src/components/GeneratePreflightDialog.tsx     | 286 ++++++++
 ...
 src/shared/channels.ts                             | 193 +++++-
 src/shared/clip-snap.ts                            | 149 +++++
 src/shared/generate-preflight.ts                   | 363 ++++++++++
 src/shared/jobs.ts                                 | 142 +++-
 ...
 tests/unit/generate-preflight-dialog.spec.tsx      | 315 +++++++++
 ...
 vitest.config.ts                                   |  12 +-
 243 files changed, 26883 insertions(+), 1063 deletions(-)
```
