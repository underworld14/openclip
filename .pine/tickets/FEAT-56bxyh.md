...
- Commits (2):
  - `5df09690` — feat(ai): BYOK cost estimate before sending, and a tokenizer that survives CJK (FEAT-56bxyh)
...
```
 ...
 vitest.config.ts                                   |  12 +-
 251 files changed, 30333 insertions(+), 1111 deletions(-)
```
