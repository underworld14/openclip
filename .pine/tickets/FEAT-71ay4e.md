...
- Commits (2):
  - `0d928549` — feat(clips): poster frame, hover preview and transcript excerpt on clip cards (FEAT-71ay4e)
...
```
 ...
 vitest.config.ts                                   |  12 +-
 235 files changed, 24141 insertions(+), 991 deletions(-)
```
