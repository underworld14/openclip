...
- Commits (2):
  - `1613909f` — feat(export): letterbox and blurred-bar fit modes, plus a real aspect-ratio picker (FEAT-bd87vz)
...
```
 ...
 src/main/services/jobs/export-runner.ts            | 150 ++++-
 ...
 vitest.config.ts                                   |  12 +-
 245 files changed, 27675 insertions(+), 1075 deletions(-)
```
