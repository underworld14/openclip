...
- Commits (2):
  - `79c55acd` — docs(oss): README, LICENSE, CONTRIBUTING + ship FFmpeg's GPL licence (FEAT-d8b6bj)
...
```
 ...
 src/renderer/src/components/SettingsPanel.tsx      | 212 ++++--
 ...
 vitest.config.ts                                   |  12 +-
 194 files changed, 15641 insertions(+), 673 deletions(-)
```
