...
- Commits (2):
  - `5dc4aa3d` — feat(ai): pre-flight panel for Generate Clips — style, length, targeting, timeframe, regenerate (FEAT-n762y6)
...
```
 ...
 vitest.config.ts                                   |  12 +-
 240 files changed, 26155 insertions(+), 1017 deletions(-)
```
