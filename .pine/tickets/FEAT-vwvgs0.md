...
- Commits (2):
  - `a3be1185` — feat(transcript): click to seek, and export as SRT / VTT / text (FEAT-vwvgs0)
...
```
 ...
 src/renderer/src/components/clipView.ts            |  40 +-
 ...
 vitest.config.ts                                   |  12 +-
 233 files changed, 23453 insertions(+), 984 deletions(-)
```
